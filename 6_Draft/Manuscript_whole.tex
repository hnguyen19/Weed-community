...
\caption{\label{tab:herb-id}Crop variety or hybrid and management from 2017 to 2020}
\centering
\resizebox{\linewidth}{!}{
...
\addcontentsline{toc}{paragraph}{Weed total density and aboveground mass}
...
\addcontentsline{toc}{paragraph}{Weed individual species relative and absolute abundance}
...
\caption{\label{tab:sp-pval}Significance of difference in abundance of the top seven weed species. Weed species are listed alphabetically. The abbreviations on the contrast column are crop identities, which are the combinations of the first letter in crop species names and the rotation to which the crops belonged.}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
...
\caption{\label{tab:sp-ct}Means of difference in abundance of the top seven weed species. Weed species are listed alphabetically. The abbreviations on the contrast column are crop identities, which are the combinations of the first letter in crop species names and the rotation to which the crops belonged.}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lrrrrrr>{}r|rrrrrrr}

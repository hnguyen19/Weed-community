...
seven_pval_round <- seven_pval_clean %>% 
 ...
 # mutate(across(is.character, "<.0001")) #not working
...
seven_pval_round %>%
  ...
  kbl(longtable = FALSE, booktabs = TRUE, linesep = "", align = 'lrrrrrrrrrrrrrr',
    caption = "Significance of difference in abundance of the top seven weed species. Weed species are listed alphabetically. The abbreviations on the contrast column are crop identities, which are the combinations of the first letter in crop species names and the rotation to which the crops belonged.") %>% 
...
seven_ct_clean %>%
  ...
  kbl(longtable = FALSE, booktabs = TRUE, digits = 2,
    ...
    caption = "Means of difference in abundance of the top seven weed species. Weed species are listed alphabetically. The abbreviations on the contrast column are crop identities, which are the combinations of the first letter in crop species names and the rotation to which the crops belonged.") %>% 
  add_header_above(c(" " = 1, "Stand density" = 7, "Aboveground mass" = 7)) %>% 

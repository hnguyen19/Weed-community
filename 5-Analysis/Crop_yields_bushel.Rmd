...
corn.lmer <- lmer(log(`Yield (bu/acre @ 15.5%)`) ~ Block +
...
soy.lmer <- lmer(log(`Yield (bu/acre @ 13.5%)`) ~ Block +  Crop_ID*Corn_weed_management + 
                    (1|Year) + 
                    (1|Year:Block) + 
                    (1|Year:Crop_ID) +
                    (1|Year:Corn_weed_management) + 
...
oat.lmer <- lmer(log(`Yield (bu/acre @ 14%)`) ~ Block + 
                   Crop_ID + 
                   (1|Year) +
                   (1|Year:Block) +  
                   (1|Year:Crop_ID), 

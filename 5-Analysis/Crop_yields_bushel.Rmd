...
crops.emmip <- rbind(corn.emmip, soy.emmip, oat.emmip, 
                     corn.emmip.bu, soy.emmip.bu, oat.emmip.bu, 
                     alf.emmip) # bu/ac and ton/ac together
...
IA_avg_yield <- IA_yield %>% 
  ...
  mutate(IA_avg_10bu = ifelse(Commodity == "corn", IA_avg_ton * 2000/ 560,
                                ifelse(Commodity == "soybeans", IA_avg_ton * 2000/ 600,
                                       ifelse(Commodity == "oats", IA_avg_ton * 2000/ 320 ,
                                              NA )))) 
...
Boone_yield <- IA_yield %>%
  ...
  mutate(Boone_avg_10bu = ifelse(Commodity == "corn", Boone_avg_ton * 2000/ 560,
                                ifelse(Commodity == "soybeans", Boone_avg_ton * 2000/ 600,
                                       ifelse(Commodity == "oats", Boone_avg_ton * 2000/ 320,
                                              NA )))) 
```

...
corn.lmer <- lmer(log(`Yield (ton/acre @ 0%)`) ~ Block +
...
soy.lmer <- lmer(log(`Yield (ton/acre @ 0%)`) ~ Block +  Crop_ID*Corn_weed_management + 
                    (1|Year) + 
                    (1|Year:Block) + 
                    (1|Year:Crop_ID) +
                    (1|Year:Corn_weed_management) + 
...
oat.lmer <- lmer(log(`ton/acre at 0% moisture`) ~ Block + 
                   Crop_ID + 
                   (1|Year) +
                   (1|Year:Block) +  
                   (1|Year:Crop_ID),
